...
class FAQ_CategoryAdapter extends RecyclerView.Adapter<FAQ_CategoryAdapter.ViewHolder> {
    ...
    public FAQ_CategoryAdapter(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_item, parent, false);
...
// boolean
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            mLinearLayout = itemView.findViewById(R.id.cate_item);

            this.question = itemView.findViewById(R.id.ques_text1);
